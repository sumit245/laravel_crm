...
@section("content")
  <div class="content-wrapper p-2">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Update Site Data</h4>
        ...
        @endif
        <form class="forms-sample" action="{{ route("projects.update", $site->id) }}" method="POST">
          @csrf
          @method("PUT")
          <div class="form-group">
            <label for="site_name" class="form-label">Project Name</label>
            <input type="text" name="project_name" class="form-control" id="site_name" placeholder="BREDA"
              value="{{ old("project_name", $site->site_name) }}">
          </div>
          {{-- <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="work_order_number" class="form-control" id="work_order_number"
              placeholder="PO202412-01" value="{{ old("project_name", $site->work_order_number) }}">
          </div>
          <div class="form-group">
            <label for="rate" class="form-label">Rate</label>
            <input type="text" name="rate" class="form-control" id="rate" placeholder="50L"
              value="{{ old("project_name", $site->rate) }}">
          </div> --}}
