        ...
        <div class="mb-4">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover" style="margin-bottom: 0;">
                    <thead style="background: #f8f9fa;">
                        <tr>
                            <th style="font-weight: 600; font-size: 0.85rem; color: #495057; padding: 10px 12px;">Panchayat
                            </th>
                            <th style="font-weight: 600; font-size: 0.85rem; color: #495057; padding: 10px 12px;">District
                            </th>
                            <th style="font-weight: 600; font-size: 0.85rem; color: #495057; padding: 10px 12px;">Total
                                Poles</th>
                            <th style="font-weight: 600; font-size: 0.85rem; color: #495057; padding: 10px 12px;">Installed
                            </th>
                            <th style="font-weight: 600; font-size: 0.85rem; color: #495057; padding: 10px 12px;">Speed
                                (poles/day)</th>
                            <th style="font-weight: 600; font-size: 0.85rem; color: #495057; padding: 10px 12px;">Status
                            </th>
                            <th style="font-weight: 600; font-size: 0.85rem; color: #495057; padding: 10px 12px;">Trend</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($performance_analytics['pole_speed_metrics'] as $panchayat)
                            <tr>
                                ...
                                <td style="padding: 10px 12px; font-size: 0.9rem;">{{ number_format($panchayat['speed'], 2) }}
                                </td>
                                <td style="padding: 10px 12px;">
