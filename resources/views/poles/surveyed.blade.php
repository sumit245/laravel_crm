    ...
    <div class="content-wrapper p-2">
        <div class="row mb-3">
            <div class="col-12">
                ...
                <p class="text-muted">Total Surveyed Poles: <strong>{{ $totalSurveyed }}</strong></p>
            </div>
        </div>

        <x-datatable id="surveyedPole" 
...
<style>
    ...
    /* Custom readable badge classes to avoid global badge-secondary color issues */
...
<script>
    ...
    $(document).ready(function() {
        ...
        function updateBulkActionsBar() {
            const selectedCount = $('#surveyedPole tbody .row-checkbox:checked').length;
            if (selectedCount > 0) {
                $('#bulkActionsBar').show();
        ...
        $('#bulkDeleteBtn').on('click', function() {
            const selectedIds = [];
            $('#surveyedPole tbody .row-checkbox:checked').each(function() {
        ...
        $(document).on('click', '.rms-status-indicator', function() {
            ...
            const successCount = $(this).data('success');
            const errorCount = $(this).data('error');
        ...
        $(document).on('change', '#surveyedPole tbody .row-checkbox, #surveyedPole_selectAll', function() {
            updateBulkActionsBar();
        });

        // Wait for DataTable to initialize
        setTimeout(function() {
            const table = $('#surveyedPole').DataTable();
            if (table) {
