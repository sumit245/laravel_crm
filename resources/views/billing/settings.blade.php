...
>>>>>>> 89c3125ce5a81b57e9efbba12838dae88d21b5cf
            </div>
            <div class="modal-footer bg-light">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                <i class="bi bi-x-circle me-1"></i> Cancel
  ...
  <div class="modal fade" id="editVehicleModal" tabindex="-1" aria-labelledby="editVehicleModalLabel"
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content shadow">
        <div class="modal-header bg-primary text-white">
          <h5 class="modal-title fw-bold" id="editVehicleModalLabel"><i class="bi bi-pencil-square me-2"></i> Edit
            Vehicle</h5>
          <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
            aria-label="Close"></button>
        </div>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="editVehicleName" name="vehicle_name" required
                    data-value-from="data-name">
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="editRatePerKm" class="form-label fw-bold">Rate per KM (₹)</label>
                  <input type="number" class="form-control" id="editRatePerKm" name="rate" step="0.01"
                    required data-value-from="data-rate">
                </div>
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="editSubCategory" name="sub_category" required
                    data-value-from="data-sub-category">
                </div>
              </div>
            </div>
            <div class="modal-footer bg-light">
      ...
      <div class="modal-content shadow">
        ...
        <div class="modal-body p-4">
          <form id="addCategoryForm" action="{{ route("billing.addcategory") }}" method="POST">
            ...
            <div class="mb-3">
              <label for="vehicle" class="form-label fw-bold">Allowed Vehicles</label>
              <select class="form-control select2" multiple id="vehicle" name="vehicle_id" required>
                <option value="" disabled>Select Allowed Vehicle</option>
                @foreach ($vehicles as $vehicle)
                  <option value="{{ $vehicle->id }}">
  ...
  <div class="modal fade" id="editCategoryModal" tabindex="-1" aria-labelledby="editCategoryModalLabel"
    ...
    <div class="modal-dialog">
      <div class="modal-content shadow">
        <div class="modal-header bg-primary text-white">
          <h5 class="modal-title fw-bold" id="editCategoryModalLabel"><i class="bi bi-pencil-square me-2"></i> Edit
            Category</h5>
          <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
            aria-label="Close"></button>
        </div>
        <div class="modal-body p-4">
          <form id="editCategoryForm">
            ...
            <div class="mb-3">
              <label for="editVehiclesAllowed" class="form-label fw-bold">Vehicles Allowed</label>
              <select id="editVehiclesAllowed" name="editVehiclesAllowed[]" multiple="multiple" class="form-select"
  ...
  <!-- Edit User Category Modal -->
  <div class="modal fade" id="editCategoryModal {{ $cat->id ?? 0 }}" tabindex="-1"
    aria-labelledby="editCategoryModalLabel{{ $cat->id ?? 0 }}" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content shadow">
        <div class="modal-header bg-primary text-white">
          <h5 class="modal-title fw-bold" id="editCategoryModalLabel{{ $cat->id ?? 0 }}"><i
              class="bi bi-pencil-square me-2"></i> Edit Category</h5>
          <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
            aria-label="Close"></button>
        </div>
        <div class="modal-body p-4">
  ...
  <div class="modal fade" id="assignCategoryModal" tabindex="-1" aria-labelledby="assignCategoryModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content shadow">
        <div class="modal-header bg-primary text-white">
          <h5 class="modal-title fw-bold" id="assignCategoryModalLabel"><i class="bi bi-tag-multiple me-2"></i> Assign
            Category to Users</h5>
          <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
            aria-label="Close"></button>
        </div>
        <div class="modal-body p-4">
