                                                ...
                                                <div id="documentUploads">
                                                    <div class="row g-3 align-items-end mb-3 p-3 border rounded bg-light">
                                                        <div class="col-md-5">
                                                            ...
                                                            <input type="text" id="document_name_1" name="document_name[]" class="form-control" placeholder="e.g. Resume" >
                                    ...
                                    <div class="form-section" id="photo">
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        <label class="form-label " for="passportPhotoInput">Upload Photo</label>
                                                        <input type="file" id="passportPhotoInput" name="passport_photo" accept="image/jpeg,image/png" class="form-control" >
