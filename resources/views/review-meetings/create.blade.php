                  ...
                  <div class="rounded border p-2">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                      ...
                      <a href="javascript:void(0);" class="text-primary small select-all"
                        data-role="{{ \Illuminate\Support\Str::slug($role, "_") }}">
                        Select All
                      </a>
                    </div>
                    <input type="text" class="form-control participant-search mb-2" placeholder="Search..."
                      data-role="{{ \Illuminate\Support\Str::slug($role, "_") }}">
                    <div class="participant-scroll role-group-{{ \Illuminate\Support\Str::slug($role, "_") }}">
                      @foreach ($roleUsers as $user)
                        <label class="circle-checkbox-label d-flex align-items-start mb-2 gap-2">
                          <input type="checkbox" name="users[]" value="{{ $user->id }}"
                            class="circle-checkbox role-{{ \Illuminate\Support\Str::slug($role, "_") }}">
                          <span>
