...
--}}
  ...
  <div class="container mt-4">
      ...
      <form id="jicrForm" action="{{ route("jicr.generate") }}" method="GET" class="d-inline">
        ...
        <div class="row">
          <div class="col-md-4 mb-3">
            ...
            <p>{{ $streetlightTask->site->district }}</p>
          </div>
          <div class="col-md-4 mb-3">
            <strong>Block</strong>
            <p> {{ $streetlightTask->site->block }}</p>
          </div>
          <div class="col-md-4 mb-3">
            <strong>Panchayat</strong>
            <p>{{ $streetlightTask->site->panchayat }}</p>
          </div>
          <div class="col-md-4 mb-3">
            <strong>Alloted Wards</strong>
            <p> {{ $streetlightTask->site->ward }}</p>
          </div>
          <div class="col-md-4 mb-3">
            <strong>Mukhiya Contact</strong>
            <p>{{ $streetlightTask->site->mukhiya_contact }}</p>
          </div>
          <div class="col-md-4 mb-3">
            <strong>Surveyed Poles</strong>
            <p> {{ $streetlightTask->site->number_of_surveyed_poles }}</p>
          </div>
          <div class="col-md-4 mb-3">
            <strong>Installed Poles</strong>
            <p> {{ $streetlightTask->site->number_of_installed_poles }}</p>
          </div>
          <div class="col-md-4 mb-3">
            <strong>Total Poles</strong>
            <p> {{ $streetlightTask->site->total_poles }}</p>
          </div>
        </div>
    </div>
    <hr class="my-1" />
    ...
    <div class="row">
      <div class="col-3 mb-2">
        <label for="fromDate" class="form-label">From Date</label><input type="date" id="fromDate" name="from_date"
    ...
    <div class="col-md-4 mb-4">
      <a href="{{ route("staff.show", $streetlightTask->manager->id) }}">
        <div class="card d-flex align-items-center flex-row p-3 shadow-sm">
          <img src="{{ $streetlightTask->manager->image }}" alt="{{ $streetlightTask->manager->firstName }}"
    ...
    <div class="col-md-4 mb-4">
      <a href="{{ route("staff.show", $streetlightTask->vendor->id) }}">
        <div class="card d-flex align-items-center flex-row p-3 shadow-sm">
          <img src="{{ $vendor->image }}" alt="{{ $vendor->name }}" class="rounded-circle" width="60"
            height="60">
          <div class="ms-3">
    ...
    <div class="col-md-4 mb-4">
      <a href="{{ route("staff.show", $streetlightTask->engineer->id) }}">
        <div class="card d-flex align-items-center flex-row p-3 shadow-sm">
          <img src="{{ $streetlightTask->engineer->image }}" alt="{{ $streetlightTask->engineer->firstName }}"
            class="rounded-circle" width="60" height="60">
          <div class="ms-3">
            <h5 class="mb-0">{{ $streetlightTask->engineer->firstName }} {{ $streetlightTask->engineer->lastName }}
            </h5>
  ...
  <div class="tab-content mt-1" id="poleTabsContent">
    ...
    <ul class="nav nav-tabs fixed-navbar-project" id="poleTabs" role="tablist">
      <li class="nav-item" role="presentation">
        <button class="nav-link active" id="installed-tab" data-bs-toggle="tab" data-bs-target="#installed"
          type="button" role="tab" aria-controls="installed" aria-selected="true">
          Installed Poles
        </button>
      </li>
      <li class="nav-item" role="presentation">
