  ...
  <body>
    ...
    <div class="card border-0 shadow-sm">
      <div class="card-header border-bottom bg-white">
        <h4 class="fw-semibold mb-0">Uploaded Documents</h4>
      </div>
      <div class="card-body">
          ...
          <div class="row g-3">
            @foreach ($data["documents"] as $docName => $docPath)
              <div class="col-md-3 col-sm-4 col-6">
                <div class="rounded-3 hover-shadow position-relative h-100 overflow-hidden border transition-all">
                  <!-- File Thumbnail -->
                  <a href="{{ asset("storage/" . $docPath) }}" target="_blank" class="d-block">
                    <div class="bg-light position-relative" style="height: 160px;">
                      <img src="{{ asset("storage/thumbnails/" . pathinfo($docPath, PATHINFO_FILENAME) . ".jpg") }}"
                        ...
                        alt="{{ $docName }}" class="img-fluid w-100 h-100" style="object-fit: cover;">
                    </div>
                  </a>

                  <!-- File Name + Menu -->
                  <div class="d-flex justify-content-between align-items-start bg-white p-2">
                    <div class="text-truncate small fw-medium" title="{{ $docName }}"
