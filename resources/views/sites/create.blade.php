            ...
            <div class="card-body">
                ...
                @if (isset($projectType) && $projectType == 1)
                    ...
                    <form action="{{ route('sites.store') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary">Add Streetlight Site</button>
                    </form>
                @else
